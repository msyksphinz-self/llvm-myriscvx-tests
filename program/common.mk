...
$(1).riscv32.static.S: $(1).riscv32.static.bc Makefile
	-$(LLC) -march=riscv32		$(COMMON_OPTIONS) -relocation-model=static -filetype=asm -o $(1).riscv32.static.S $(1).riscv32.static.bc		> $(1).riscv32.static.asm.log 2>&1
$(1).riscv64.static.S: $(1).riscv64.static.bc Makefile
	-$(LLC) -march=riscv64		$(COMMON_OPTIONS) -relocation-model=static -filetype=asm -o $(1).riscv64.static.S $(1).riscv64.static.bc		> $(1).riscv64.static.asm.log 2>&1
$(1).riscv32.static.o: $(1).riscv32.static.bc Makefile
	-$(LLC) -march=riscv32		$(COMMON_OPTIONS) -relocation-model=static -filetype=obj -o $(1).riscv32.static.o $(1).riscv32.static.bc		> $(1).riscv32.static.obj.log 2>&1
$(1).riscv64.static.o: $(1).riscv64.static.bc Makefile
	-$(LLC) -march=riscv64		$(COMMON_OPTIONS) -relocation-model=static -filetype=obj -o $(1).riscv64.static.o $(1).riscv64.static.bc		> $(1).riscv64.static.obj.log 2>&1
$(1).myriscvx32.static.S: $(1).riscv32.static.bc Makefile
	-$(LLC) -march=myriscvx32	$(COMMON_OPTIONS) -relocation-model=static -filetype=asm -o $(1).myriscvx32.static.S $(1).riscv32.static.bc	> $(1).myriscvx32.static.asm.log 2>&1
$(1).myriscvx64.static.S: $(1).riscv64.static.bc Makefile
	-$(LLC) -march=myriscvx64	$(COMMON_OPTIONS) -relocation-model=static -filetype=asm -o $(1).myriscvx64.static.S $(1).riscv64.static.bc	> $(1).myriscvx64.static.asm.log 2>&1
$(1).myriscvx32.static.o: $(1).riscv32.static.bc Makefile
	-$(LLC) -march=myriscvx32	$(COMMON_OPTIONS) -relocation-model=static -filetype=obj -o $(1).myriscvx32.static.o $(1).riscv32.static.bc	> $(1).myriscvx32.static.obj.log 2>&1
$(1).myriscvx64.static.o: $(1).riscv64.static.bc Makefile
	-$(LLC) -march=myriscvx64	$(COMMON_OPTIONS) -relocation-model=static -filetype=obj -o $(1).myriscvx64.static.o $(1).riscv64.static.bc	> $(1).myriscvx64.static.obj.log 2>&1
...
$(1).myriscvx32.static.medany.S: $(1).riscv32.static.bc Makefile
	-$(LLC) -march=myriscvx32	$(COMMON_OPTIONS) -relocation-model=static --code-model=medium -filetype=asm -o $(1).myriscvx32.static.medany.S $(1).riscv32.static.bc		> $(1).myriscvx32.pic.asm.log 2>&1
$(1).myriscvx64.static.medany.S: $(1).riscv64.static.bc Makefile
	-$(LLC) -march=myriscvx64	$(COMMON_OPTIONS) -relocation-model=static --code-model=medium -filetype=asm -o $(1).myriscvx64.static.medany.S $(1).riscv64.static.bc		> $(1).myriscvx64.pic.asm.log 2>&1

$(1).riscv32.pic.S: $(1).riscv32.pic.bc Makefile
	-$(LLC) -march=riscv32		$(COMMON_OPTIONS) -relocation-model=pic -filetype=asm -o $(1).riscv32.pic.S $(1).riscv32.pic.bc			> $(1).riscv32.pic.asm.log 2>&1
$(1).riscv64.pic.S: $(1).riscv64.pic.bc Makefile
	-$(LLC) -march=riscv64		$(COMMON_OPTIONS) -relocation-model=pic -filetype=asm -o $(1).riscv64.pic.S $(1).riscv64.pic.bc		> $(1).riscv64.pic.asm.log 2>&1
$(1).riscv32.pic.o: $(1).riscv32.pic.bc Makefile
	-$(LLC) -march=riscv32		$(COMMON_OPTIONS) -relocation-model=pic -filetype=obj -o $(1).riscv32.pic.o $(1).riscv32.pic.bc			> $(1).riscv32.pic.obj.log 2>&1
$(1).riscv64.pic.o: $(1).riscv64.pic.bc Makefile
	-$(LLC) -march=riscv64		$(COMMON_OPTIONS) -relocation-model=pic -filetype=obj -o $(1).riscv64.pic.o $(1).riscv64.pic.bc			> $(1).riscv64.pic.obj.log 2>&1
$(1).myriscvx32.pic.S: $(1).riscv32.pic.bc Makefile
	-$(LLC) -march=myriscvx32	$(COMMON_OPTIONS) -relocation-model=pic -filetype=asm -o $(1).myriscvx32.pic.S $(1).riscv32.pic.bc		> $(1).myriscvx32.pic.asm.log 2>&1
$(1).myriscvx64.pic.S: $(1).riscv64.pic.bc Makefile
	-$(LLC) -march=myriscvx64	$(COMMON_OPTIONS) -relocation-model=pic -filetype=asm -o $(1).myriscvx64.pic.S $(1).riscv64.pic.bc		> $(1).myriscvx64.pic.asm.log 2>&1

$(1).myriscvx32.pic.o: $(1).riscv32.pic.bc Makefile
	-$(LLC) -march=myriscvx32	$(COMMON_OPTIONS) -relocation-model=pic -filetype=obj -o $(1).myriscvx32.pic.o $(1).riscv32.pic.bc		> $(1).myriscvx32.pic.obj.log 2>&1
$(1).myriscvx64.pic.o: $(1).riscv64.pic.bc Makefile
	-$(LLC) -march=myriscvx64	$(COMMON_OPTIONS) -relocation-model=pic -filetype=obj -o $(1).myriscvx64.pic.o $(1).riscv64.pic.bc		> $(1).myriscvx64.pic.obj.log 2>&1
$(1).myriscvx32.pic.medany.S: $(1).riscv32.pic.bc Makefile
	-$(LLC) -march=myriscvx32	$(COMMON_OPTIONS) -relocation-model=pic --code-model=medium -filetype=asm -o $(1).myriscvx32.pic.medany.S $(1).riscv32.pic.bc		> $(1).myriscvx32.pic.asm.log 2>&1
$(1).myriscvx64.pic.medany.S: $(1).riscv64.pic.bc Makefile
	-$(LLC) -march=myriscvx64	$(COMMON_OPTIONS) -relocation-model=pic --code-model=medium -filetype=asm -o $(1).myriscvx64.pic.medany.S $(1).riscv64.pic.bc		> $(1).myriscvx64.pic.asm.log 2>&1
